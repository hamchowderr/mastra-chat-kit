...
// The Schedules panel renders the harness agent's recurring schedules (native
// mastra.schedules), fetched from /api/harness/schedules. Read-only + agent-driven.
describe('WorkbenchSchedules — recurring schedules panel', () => {
  ...
  it('renders a schedule card with its cron, prompt, and active status', () => {
    const schedules: HarnessSchedule[] = [
      {
        id: 'agent_standup',
        cron: '0 9 * * *',

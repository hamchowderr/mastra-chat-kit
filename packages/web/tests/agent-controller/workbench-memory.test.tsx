...
// The Memory panel renders the controller agent's Observational-Memory state (token
...
describe('WorkbenchMemory — observational-memory panel', () => {
  ...
  it('renders hydrated learned facts even before a run (no status yet)', () => {
    // Facts hydrated from /api/agent-controller/om on mount: observations present, status still null.
    const memory: AgentControllerMemory = {
      status: null,
      activity: [],

# AgentController Events Reference — `AgentControllerEvent` (all 50)
...
> ✅ **`mastra-chat-kit-vud` (fixed 2026-07-25):** the controller tool flow works with OpenAI. An earlier
...
## Legend
- **Consumed** — a `case` in `reduceAgentControllerEvent` folds it into the transcript today.
